export const TOKENS = {
  ...
  CATEGORY_REPOSITORY: Symbol.for("ICategoryRepository"),
  CATEGORY_SERVICE: Symbol.for("ICategoryService"),
  CATEGORY_CONTROLLER: Symbol.for("ICategoryController"),
  ...
  PAYMENT_CONTROLLER: Symbol.for("IPaymentConroller"),
  ...
  TERMINAL_SESSION_MODEL: Symbol.for("TerminalSessionModel"),
  TERMINAL_SESSION_REPOSITORY: Symbol.for("ITerminalSessionRepository"),
  TERMINAL_SESSION_SERVICE: Symbol.for("ITerminalSessionService"),
